...
function Dashboard(props) {
  ...
  var onImportJson = function (json) {
    var maxPosition = Core__Array.reduce(allTodos, 0, (function (a, c) {
            return Math.max(a, c.self.position);
          }));
    State.batch(function () {
          var idMap = json.map(function (v) {
                return [
                        v.id,
                        Uuid.v4()
                      ];
          ...
          json.forEach(function (v, i) {
                var x = v.parent_todo;
                var tmp;
                tmp = x === null || x === undefined ? null : Core__Option.mapOr(idMap.find(function (param) {
                            return param[0] === x;
                          }), null, (function (param) {
                          return param[1];
                        }));
                Common.addTodoByImport(Core__Option.mapOr(idMap.find(function (param) {
                              return param[0] === v.id;
                            }), Uuid.v4(), (function (param) {
                            return param[1];
                          })), v.text, tmp, maxPosition + i, v.status);
              });
        });
  };
  var tmp;
