...
function statusIcon(s) {
  switch (s) {
    ...
    case "LaterUnlikely" :
        return "C";
    case "LaterUnsorted" :
        return JsxRuntime.jsx(Tb.TbMinus, {});
    case "ResolveDone" :
    case "ArchiveDone" :
        return JsxRuntime.jsx(Tb.TbCheck, {});
    case "ResolveReject" :
    case "ArchiveReject" :
        return JsxRuntime.jsx(Tb.TbX, {});
    case "ResolveNoNeed" :
    case "ArchiveNoNeed" :
        return JsxRuntime.jsx(Tb.TbSlash, {});
    case "Trash" :
        return JsxRuntime.jsx(Tb.TbTrash, {});
